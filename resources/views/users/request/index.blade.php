...
<x-main-layout>
    ...
    <script>
        ...
        function viewRequest(requestId, month, year) {
            //window.location.href = `/request/${requestId}?&type=view`;
            window.location.assign(`/request/${requestId}?&type=view`);
        }


        function downloadRequest(requestId, month, year) {
            //window.location.href = `/request/${requestId}?&type=download`;
            window.location.assign(`/request/${requestId}?&type=download`);
        }
